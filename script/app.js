...
const K /* Kelvin */ = 273;
const key = "82005d27a116c2880c8f0fcb866998a0"; //api key-u luat de la openweathermap.org
...
function getWeather(latitude, longitude) {
    let api = `http://api.openweathermap.org/data/2.5/weather?lat=${latitude}&lon=${longitude}&appid=${key}`; //weather api
...
// for the goddamn Americans
function celsiusToFahrenheit(temperature) {
    return (temperature * 9 / 5) + 32;
}

// for chads or hippies
